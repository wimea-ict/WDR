            ...
            if ($result) {
                ...
                foreach ($result as $row) {
                    ...
                    $usersessiondata = array(
                        ...
                        'UserRegion' => $region,
                        'UsersRegion'=>$row->region_zone,
                        'UserSubRegion' => $row->UserSubRegion
                    );
                 }//end of foreach
                ...
                if($session_data['Reset']==1){
                   ...
                   // $guy =firstcharuppercase(chgtolowercase($test));
                    ...
                    //Load the next page
                    if($userrole== "Senior Weather Observer" || $userrole== "Observer" || $userrole=="ObserverDataEntrant")
                    if($stationtype=="Rainfall")
                    redirect(base_url()."index.php/ObservationSlipForm/showWebmobiledatarainfall");
                    else
                    ...
                    elseif ( $userrole=="DataOfficer")
                       redirect(base_url()."index.php/ArchiveMetarFormData");
                    elseif($userrole=="SeniorDataOfficer" )
                ...
                if($randompassword){
                    ...
                    if($successfullysent){
                        ...
                        if($updatesuccess){
                            ...
                            $this->session->set_flashdata('error', 'Password has not been reset but Email has been sent to you');
                            $this->load->view('forgotPassword');
