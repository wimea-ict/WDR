...
class AWSgndDataController extends CI_Controller {
   ...
   public function index(){
			...
			$data['dateform_action'] = base_url()."index.php/AWSgndDataController/";
        ...
        $query = $this->DbHandler->selectAllAWSData('GroundNode',$from,$to);
          //var_dump($query);
        if ($query) {
        ...
        $this->load->view('displayGndData', $data);
    }
