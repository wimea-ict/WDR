...
class AWS10mDataController extends CI_Controller {
   ...
   public function index(){
           ...
           $userrole=$session_data['UserRole'];
			...
			$data['dateform_action'] = base_url()."index.php/AWS10mDataController/";
        ...
        $query = $this->DbHandler->selectAllAWSData('TenMeterNode',$from,$to,'StationName');
          //var_dump($query);
        if ($query) {
        ...
        $this->load->view('display10mData', $data);
    }
