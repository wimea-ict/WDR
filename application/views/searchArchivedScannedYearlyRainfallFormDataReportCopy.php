...
?>
    <aside class="right-side">
        ...
        <section class="content-header">
            <h1>
                Search Archived Scanned Annual Rainfall Form Report
                <small> Page</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Search Archived  Scanned Annual Rainfall Form Report</li>
        ...
        <section class="content report">
            <div class="no-print">
                <div id="output"></div>
                <div class="row">
                    <form action="<?php echo base_url(); ?>index.php/SearchArchivedScannedYearlyRainfallFormDataReportCopy/displayarchivedscannedyearlyrainfallformreport/" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="submit" name="searchArchivedScannedYearlyRainfallFormReport_button" id="searchArchivedScannedYearlyRainfallFormReport_button" class="btn btn-primary" value="Search " >
                        </div>
                    </form>
                </div>
                <hr>
            ...
            <?php
            if(is_array($displayArchivedScannedYearlyRainfallFormReportDetails)
                && count($displayArchivedScannedYearlyRainfallFormReportDetails) &&
            is_array($archivedscannedyearlyrainfallformreportdataForAYear) &&
                !empty($archivedscannedyearlyrainfallformreportdataForAYear)) {
                ...
                //$monthInWords= $displayArchivedScannedYearlyRainfallFormReportDetails['monthInWords'];
                //$monthAsANumber= $displayArchivedScannedWeatherSummaryFormReportDetails['monthAsANumberselected'];

                $year= $displayArchivedScannedYearlyRainfallFormReportDetails['year'];




                $stationName=$displayArchivedScannedYearlyRainfallFormReportDetails['stationName'];
                $stationNumber=$displayArchivedScannedYearlyRainfallFormReportDetails['stationNumber'];
                ?>
                <h3>ARCHIVE SCANNED YEARLY RAINFALL REPORT</h3>
                <br>
                ...
                <table class="report-table" id="table2excel">
                    ...
                    <?php
                    $count = 0;
                       foreach($archivedscannedyearlyrainfallformreportdataForAYear as $data){
                            $count++;
                            $metarid = $data->id;
                ...
                <a href="<?php echo base_url()."index.php/SearchArchivedScannedYearlyRainfallFormDataReportCopy/"; ?>" class="btn btn-warning pull-right no-print"><i class="fa fa-times"></i> Close report</a>
                <div class="clearfix"></div>
                <br><br>


            <?php
            }elseif(is_array($displayArchivedScannedYearlyRainfallFormReportDetails)
    && count($displayArchivedScannedYearlyRainfallFormReportDetails) &&
    is_array($archivedscannedyearlyrainfallformreportdataForAYear) &&
    empty($archivedscannedyearlyrainfallformreportdataForAYear)) {
                ...
                <center>
                    <?php echo "No Archived Scanned Annual Report  for ".$stationName.' '.'And Year'.'  '.$year.'   From the DB'; ?>
                </center>
