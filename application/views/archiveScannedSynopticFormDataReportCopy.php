...
?>
    ...
    if(is_array($displaynewFormToArchiveScannedSynopticFormReportDetails) && count($displaynewFormToArchiveScannedSynopticFormReportDetails)) {
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select  name="station_ArchiveScannedSynopticFormReport" class="form-control"  id="stations-list"
        ...
        <center>
            ...
            <button type="submit" id="postScannedSynopticFormDataReportCopy_button" name="postScannedSynopticFormDataReportCopy_button" class="btn btn-primary"><i class="fa fa-plus"></i> NEXT</button>
        </center>
        </form>
        </div>
    <?php
                         ...
                         <form action="<?php echo base_url(); ?>index.php/ArchiveScannedSynopticFormDataReportCopy/updateInformationForArchiveScannedSynopticFormReport" method="post" enctype="multipart/form-data">
                           <h3 class='text-center'>SCANNED RECORD DETAILS</h3>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Date</span>
                                    <input type="text" <?php if($userrole=="SeniorDataOfficer") echo 'readonly'; ?> name="dateOnScannedSynopticFormReport" required class="form-control" placeholder="Enter date on the scanned form " value="<?php echo $idDetails->form_date;?>" id="expdate"  class="form-control">
                                </div>
                            </div>
             ...
             <form action="<?php echo base_url(); ?>index.php/ArchiveScannedSynopticFormDataReportCopy/insertInformationForArchiveScannedSynopticFormFiles/"  method="post" enctype="multipart/form-data">
                    <div class="row" >
                      ...
                      <div class="form-group">
                                ...
                                <input type="hidden"  name="file_type" value="scannedsynoptic"/>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                                       ...
                                       <!--  <td><?php echo $data->comment ;?></td> -->
                                        <td class="no-print"> 
                                                ...
                                                <?php if($data->Approved=="FALSE" || $userrole!='DataOfficer'){ ?>
                                                  ...
                                                  <a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>index.php/ArchiveScannedSynopticFormDataReportCopy/index/<?php echo $data->id ?>/">View/ Add Comments</a> <br><br>
                                                <?php }else{ ?> 
                                   ...
                                   <?php if($userrole=="Senior Weather Observer"|| $userrole=="ObserverArchive"||$userrole=="DataOfficer"||$userrole=="SeniorDataOfficer"){?>
                                    ...
                                    <table>
                                         <tr>
                                            ...
                                            <a  class= "btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/ArchiveScannedSynopticFormDataReportCopy/DisplayFormToArchiveScannedSynopticFormReportForUpdate/" .$data->id ;?>" style="cursor:pointer;"><li class="fa fa-edit"></li> Edit</a>
                                        <?php } else{?>
                                           <!--  <a  class= "btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/ArchiveScannedSynopticFormDataReportCopy/DisplayFormToArchiveScannedSynopticFormReportForUpdate/" .$data->id ;?>" style="cursor:pointer;"><li class="fa fa-edit"></li>Add comment</a> -->
                                        <?php }?>
                                    </td>
                 <?php if($userrole== 'SeniorDataOfficer' && $data->Approved=="TRUE" ){?>
                        ...
                        <br>
                        <a style="margin-left:10px;" href="<?php echo base_url(); ?>index.php/ArchiveScannedSynopticFormDataReportCopy/" class='btn btn-info btn-xs'><< Back to all records</a>
                          <?php if(isset($observationslipcomments)){ ?>
                              ...
                              <div class="row no-print" style="padding:10px;">
                                ...
                                <div class="col-md-6">
                                <h4 >Add a comment</h4>
                                <form method="post" action="<?php echo base_url(); ?>index.php/ArchiveScannedSynopticFormDataReportCopy/submitObservationslipComment/">
                                <input type="hidden" name="recordid" value="<?php echo $scannedsynopticformdatadetails ?>" id="">
