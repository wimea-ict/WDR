...
?>
    ...
    <div class="no-print">
        ...
        <div class="row">
            <form action="<?php echo base_url(); ?>index.php/SearchArchivedScannedWeatherSummaryFormDataReportCopy/displayarchivedscannedweathersummaryformreport/" method="post" enctype="multipart/form-data">
                ...
                <?php }elseif($userrole=='ManagerData' || $userrole=='SeniorDataOfficer'|| $userrole=='Manager'){?>
                    <div class="col-xs-3">
                        <div class="form-group">
                            <div class="input-group">
    ...
    if(is_array($displayArchivedScannedWeatherSummaryFormReportDetails)
        ...
        ?>
        <h3>ARCHIVE SCANNED WEATHER SUMMARY REPORT</h3>
                <br>
        ...
        <a href="<?php echo base_url()."index.php/SearchArchivedScannedWeatherSummaryFormDataReportCopy/"; ?>" class="btn btn-warning pull-right no-print"><i class="fa fa-times"></i> Close report</a>
        <div class="clearfix"></div>
        <br><br>
