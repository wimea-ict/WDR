                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive" style="overflow:auto;">
                        <table id="example4" class="table table-bordered table-fixed table-striped">
							...
							$winddirection = ((($observationslipdata->V_A1/$observationslipdata->V_A2)-0.05)*400); 
							}else{
							  $winddirection = 0; 
								}										
                                  ?>
                                ...
                                z-index: 99;"><?php echo $observationslipdata->id;?></td>
                                     <td style="width:65px">echo "$nbsp";</td>
                                      ...
                                      <td ><?php echo $observationslipdata->P0_LST60;?></td>
                                      <td><?php echo $winddirection;?></td>
									   <td ><?php echo $observationslipdata->V_AD1;?></td>
											</tr>
							<?php } } ?>
                            </tbody>
                        </table>
