...
?>
        ...
        <section class="content report">
            ...
            <div class="no-print">
                ...
                <?php if(!isset($reportonly)){ ?>
                    <form autocomplete="off" action="<?=site_url('generate-metar-report')?>" method="post" enctype="multipart/form-data">
                        ...
                        elseif($userrole=='ManagerData' ||$userstation=='Manager' || $userrole=="ManagerStationNetworks" || $userrole=="Director" || $userrole=='WeatherAnalyst' || $userrole == 'Communications'){
                            ?>
                                   <div class="col-xs-3">
                        <div class="form-group">
                            <div class="input-group">
   ...
   <?php } ?>
         ...
         <?php if($userrole=='Senior Weather Observer' || $userrole=="WeatherForecaster"){ ?>
                        ...
                        <?php } elseif($userrole=='ManagerData' ||$userrole=='Manager' || $userrole== "ZonalOfficer" || $userrole== "SeniorZonalOfficer" || $userrole=="ManagerStationNetworks" || $userrole=="Director"  || $userrole=='WeatherAnalyst' || $userrole == 'Communications'){
                            ?>
                            <div class="col-xs-3">
                                <div class="form-group">
                                    <div class="input-group">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="date" id="date" class="form-control summonth" placeholder="select the date" autocomplete="off" required >
                                </div>
                            </div>
                        </div>
            ...
            <div class="input-group timepicker">
             <input id="timepicker1" type="text" name="metarTime"  class="form-control" autocomplete="off" >
       ...
       <div class="col-xs-2">
        ...
        <?php } ?>
            ...
            $displayMetarReportHeaderFields = $data['displayMetarReportHeaderFields'];
            $metarreportdataforADayFromObservationSlipTable = $data['metarreportdataforADayFromObservationSlipTable'];

            $stationIndicatorData = $data['stationIndicatorData'];

            //var_dump($data);
            //var_dump($metarreportdataforADayFromObservationSlipTable);
            ...
            if(is_array($displayMetarReportHeaderFields) &&
              is_array($metarreportdataforADayFromObservationSlipTable) &&
               ...
               $blocknumber=$displayMetarReportHeaderFields['blocknumber'];
                $metartime=$displayMetarReportHeaderFields['time'];
                $region=$displayMetarReportHeaderFields['region'];
               $stationIndicator;
            //echo $stationName;
              ...
              if (is_array($stationIndicatorData) && count($stationIndicatorData)) {
                ...
                <div class="col-lg-2"  style="float: right; margin-top: -10%; width: 170px;">
                    ...
                    <form style="margin-right:140px;" action="<?php echo base_url(); ?>index.php/ReportsController/displaymetarreport/" method="post">
                    <input type="hidden" name="RegionName" value="<?php echo $region;?>">
                    <input type="hidden"  name="date" value="<?php echo $date;?>"/>
                    <input type="hidden"  name="metarTime" value="<?php echo $metartime;?>"/>
                    ...
                    <input type="hidden"  name="reporttype" value="metar"/>
                ...
                <form style="margin-right:140px;" action="<?php echo base_url(); ?>index.php/ReportsController/displaymetarreport/" method="post">
                    ...
                    <input type="hidden"  name="metarTime" value="<?php echo $reportrecod->time;?>"/>
                ...
                <table class="report-table" id="table2excel">
                    ...
                    $array_MetarReportDataForADayFromObservationSlipTable=array();
                        ...
                        foreach($metarreportdataforADayFromObservationSlipTable as $data){
                           // $count++;
                           // $metarid = $data->id;
                           $array_MetarReportDataForADayFromObservationSlipTable[$count]["recent_weather"]=$data->recent_weather;
                             $array_MetarReportDataForADayFromObservationSlipTable[$count]["mslpr_oblique"]=$data->mslpr_oblique;
                           $array_MetarReportDataForADayFromObservationSlipTable[$count]["runwayVisualRange"]=$data->runwayVisualRange;
                ...
                <input type="hidden"  name="reporttype" value="metaReport"/>
                <br><br>
                </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>
             ...
             <?php  }
            else if(is_array($metarreportdataforADayFromObservationSlipTable)
                && count($metarreportdataforADayFromObservationSlipTable) <= 0)
                            {
     ...
     <center>
         <?php echo "
         <span class='text-dangered'>No Metar Report Data Yet for ".$stationName.', '.$region.' region on '.'date'.' '.$date. ' at '.$time.' from our records</span>'; ?>
     </center>
 <?php } ?>
