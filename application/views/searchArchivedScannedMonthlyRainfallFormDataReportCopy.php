...
?>
    ...
    $stationNumber=$displayArchivedScannedMonthlyRainfallFormReportDetails['stationNumber'];
      ?>
            ...
            <h3>ARCHIVE SCANNED MONTHLY RAINFALL REPORT</h3>
                <br>
          ...
          <a href="<?php echo base_url()."index.php/SearchArchivedScannedMonthlyRainfallFormDataReportCopy/"; ?>" class="btn btn-warning pull-right no-print"><i class="fa fa-times"></i> Close report</a>
