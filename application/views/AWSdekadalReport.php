...
?>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">AWS Dekadal Report</li>
    ...
    <div class="no-print">
        <div class="row">
            <form autocomplete="off" action="<?php echo base_url(); ?>index.php/AWSDekadalReport/displaydekadalreport/" method="post" enctype="multipart/form-data">
    ...
    if(is_array($displayDekadalReportHeaderFields) && count($displayDekadalReportHeaderFields)){
        ...
        if (is_array($DekadalReportDataFromobservationslipTableforAGivenRangeInAMonthAndTime0600Z) ||
            ...
            for($daynum = $FromDatemonthDay; $daynum<=$ToDatemonthDay; $daynum++ ){
                ...
                foreach($DekadalReportDataFromobservationslipTableforAGivenRangeInAMonthAndTime0600Z as $data){
                    ...
                    if ($daynum==$data->DayOfTheMonth) {
                        ...
                        $array_DekadalReportForGivenRangeOfDaysInAMonthTime0600Z[$indexTime0600Z]["DekadalTime0600Z_Max_Read"]=$data->Max_temp;
                        $array_DekadalReportForGivenRangeOfDaysInAMonthTime0600Z[$indexTime0600Z]["DekadalTime0600Z_Min_Read"]=$data->Min_temp;
            ...
            for($daynum = $FromDatemonthDay; $daynum<=$ToDatemonthDay; $daynum++ ){
                ...
                $finalarraymerge [$i]["DekadalTime0600Z_Relative_Humidity"]= round($RH_0600Z,2);
                ...
                $finalarraymerge [$i]["DekadalTime1200Z_Relative_Humidity"]= round($RH_1200Z,2);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if(((getdayFrom_ThetoDate)-(getdayFrom_ThefromDate) != 10)
                    ){
