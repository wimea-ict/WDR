                    ...
                    <div class="box-body table-responsive" style="overflow:auto;">
                        <table id="example4" class="table table-bordered table-fixed table-striped">
                            ...
                            <tr >
                             ...
                             <span > <th>Submission Date</th></span>
							 <th>Time</th>
                             <th>Station</th>
                            ...
                            if(is_array($observationslipformdata) && count($observationslipformdata)) {
                              foreach($observationslipformdata as $observationslipdata){
                                        $count++;	
							if($observationslipdata->V_A2 && $observationslipdata->V_A2 != 0 ){
							$soilMoisture = ((($observationslipdata->V_A1/$observationslipdata->V_A2)-0.05)*400); 
							}else{
							  $winddirection = 0; 
								}
                                  ?>
                                ...
                                z-index: 99;"><?php echo $observationslipdata->id;?></td>
                                     <td style="width:65px">echo "$nbsp";</td>
                                        <td ><?php  echo $observationslipdata->RTC_T;?></td>
                                      <td ><?php echo $observationslipdata->TIME;?></td>
                                      <td ><?php echo $observationslipdata->StationName;?></td>
                                      <td ><?php echo $observationslipdata->Location;?></td>
                                      <td ><?php echo $observationslipdata->NAME;?></td>
                                      <td ><?php echo $observationslipdata->P;?></td>
                                      <td><?php echo $soilMoisture ;?></td>
									  <td><?php echo $observationslipdata->T1 ;?></td>
									  <td><?php echo ($observationslipdata->P0_LST60)*0.2 ;?></td>
											</tr>
							<?php } } ?>
                            </tbody>
                        </table>
