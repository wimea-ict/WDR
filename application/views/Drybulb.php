...
?>
    ...
    <div class="no-print">
        <div class="row">
            <form autocomplete="off" action="<?php echo base_url(); ?>index.php/ReportsController/displaydrybulb" method="post" enctype="multipart/form-data">
...
<br><br>
    ...
    <span><strong>Charts Generated BY:</strong></span> <span class="dotted-line"><?php echo $name;?></span>
      ...
      <button onClick="print();return false;" class="btn btn-primary no-print"><i class="fa fa-print"></i> Print info on this page</button>
        ...
        <a href="<?php echo base_url()."index.php/ReportsController/initializedrybulb"; ?>" class="btn btn-warning pull-right no-print"><i class="fa fa-times"></i> Close Charts</a>
        <div class="clearfix"></div>
        <br><br>
    <?php }?>
    </section><!-- /. -->
