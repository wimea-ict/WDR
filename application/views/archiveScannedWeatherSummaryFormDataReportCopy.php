...
?>
    ...
    if(is_array($displaynewFormToArchiveScannedWeatherSummaryFormReport) && count($displaynewFormToArchiveScannedWeatherSummaryFormReport)) {
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select  name="station_ArchiveScannedWeatherSummaryFormReport" class="form-control"  id="stations-list"
        ...
        <center>
                    ...
                    <button type="submit" id="postScannedArchiveWeatherSummaryFormReportDataCopy_button" name="postScannedArchiveWeatherSummaryFormReportDataCopy_button" class="btn btn-primary"><i class="fa fa-plus"></i> NEXT </button>
        </center>
            </form>
        </div>
    <?php
                    ...
                    <div class="modal-body">
                        ...
                        <h3 class='text-center'>SCANNED RECORD DETAILS</h3>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"> Month</span>
                                    <input type="text" <?php if($userrole=="SeniorDataOfficer") echo 'readonly'; ?>  name="monthOfScannedWeatherSummaryFormReport" required class="form-control" placeholder="Enter month on the scanned form " value="<?php echo $idDetails->month;?>" id="month" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Year</span>
                                    <input type="text" <?php if($userrole=="SeniorDataOfficer") echo 'readonly'; ?>  name="yearOfScannedWeatherSummaryFormReport" required class="form-control" placeholder="Enter year on the scanned form " value="<?php echo $idDetails->year;?>" id="year"  class="form-control">
                                </div>
                            </div>
             ...
             <form action="<?php echo base_url(); ?>index.php/ArchiveScannedObservationSlipFormDataCopy/insertInformationForArchiveScannedObservationSlipFormFiles/"  method="post" enctype="multipart/form-data">
                    <div class="row" >
                      ...
                      <div class="form-group">
                                ...
                                <input type="hidden"  name="file_type" value="scannedweathersummary"/>
                                       ...
                                       <!--  <td><?php echo $data->comment ;?></td> -->
                                        <td class="no-print"> 
                                                ...
                                                <?php if($data->Approved=="FALSE" || $userrole!='DataOfficer'){ ?>
                                                  ...
                                                  <a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>index.php/ArchiveScannedWeatherSummaryFormDataReportCopy/index/<?php echo $data->id ?>/">View/ Add Comments</a> <br><br>
                                                <?php }else{ ?> 
                                     ...
                                     <td class="no-print">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/ArchiveScannedWeatherSummaryFormDataReportCopy/DisplayFormToArchiveScannedWeatherSummaryFormReportForUpdate/" .$data->id ;?>" style="cursor:pointer;"> <li class="fa fa-edit"></li> Edit</a>
                                            <?php } else{?>
                                                 <!-- <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/ArchiveScannedWeatherSummaryFormDataReportCopy/DisplayFormToArchiveScannedWeatherSummaryFormReportForUpdate/" .$data->id ;?>" style="cursor:pointer;"> <li class="fa fa-edit"></li>Add Comment</a> -->
                                             <?php }?>
                                                    </td>
                    <?php if($userrole== 'SeniorDataOfficer' && $data->Approved=="TRUE" ){?>
                        <td><form method="post" action="<?php echo base_url() . "index.php/ArchiveScannedWeatherSummaryFormDataReportCopy/update_approval/" .$data->id;?>"> <input type="hidden" name="id" value="<?php echo $data->id;?>" ><input type="hidden" name="approve" value="FALSE" ><button class="btn btn-danger btn-xs"  type="submit"  ><li class='fa fa-times'></li> Disapprove</button></form>
                        ...
                        <br>
                         <a style="margin-left:10px;" href="<?php echo base_url(); ?>index.php/ArchiveScannedWeatherSummaryFormDataReportCopy/" class='btn btn-info btn-xs'><< Back to all records</a>
                           <hr>
                           <?php if(isset($observationslipcomments)){ ?>
                              ...
                              <div class="row no-print" style="padding:10px;">
                                ...
                                <div class="col-md-6">
                                <h4 >Add a comment</h4>
                                <form method="post" action="<?php echo base_url(); ?>index.php/ArchiveScannedWeatherSummaryFormDataReportCopy/submitObservationslipComment/">
