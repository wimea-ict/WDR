...
?>
    ...
    if(is_array($displaynewFormToArchiveScannedMonthlyRainfallFormReport) && count($displaynewFormToArchiveScannedMonthlyRainfallFormReport)) {
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <select  name="station_ArchiveScannedMonthlyRainfallFormReport" class="form-control"  id="stations-list"
        ...
        <center>
                    ...
                    <button type="submit" id="postScannedArchiveMonthlyRainfallFormReportDataCopy_button" name="postScannedArchiveMonthlyRainfallFormReportDataCopy_button" class="btn btn-primary"><i class="fa fa-plus"></i> NEXT </button>
                </center>
            </form>
        </div>
    <?php
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"> Month</span>
                                    <input type="text" <?php if($userrole=="SeniorDataOfficer") echo 'readonly'; ?> name="monthOfScannedMonthlyRainfallFormReport" required class="form-control" placeholder="Enter date on the scanned form " value="<?php echo $idDetails->month;?>" id="month" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">Year</span>
                                    <input type="text" <?php if($userrole=="SeniorDataOfficer") echo 'readonly'; ?> name="yearOfScannedMonthlyRainfallFormReport" required class="form-control" placeholder="Enter date on the scanned form " value="<?php echo $idDetails->year;?>" id="year" >
                                </div>
                            </div>
                ...
                <form action="<?php echo base_url(); ?>index.php/ArchiveScannedObservationSlipFormDataCopy/insertInformationForArchiveScannedObservationSlipFormFiles/"  method="post" enctype="multipart/form-data">
                    <div class="row" >
                      ...
                      <div class="form-group">
                                ...
                                <input type="hidden"  name="file_type" value="scannedmonthlyrainfall"/>
                      ...
                      <div class="form-group">
                            ...
                            <textarea <?php if($userrole=="SeniorDataOfficer") echo 'disabled'; ?> name="description" class="form-control" onkeyup=""  rows="2" id="description_observationslipform"></textarea>
                        </div>
                                       ...
                                       <!--  <td><?php echo $data->comment ;?></td> -->
                                        <td class="no-print"> 
                                                ...
                                                <?php if($data->Approved=="FALSE" || $userrole!='DataOfficer'){ ?>
                                                  ...
                                                  <a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>index.php/ArchiveScannedMonthlyRainfallFormDataReportCopy/index/<?php echo $data->id ?>/">View/ Add Comments</a> <br><br>
                                                <?php }else{ ?> 
                                   ...
                                   <?php if($userrole=="Senior Weather Observer"|| $userrole=="ObserverArchive"||$userrole=="DataOfficer"||$userrole=="SeniorDataOfficer"){ ?>
                                       <td class="no-print">
                                           ...
                                           <?php if($userrole == "DataOfficer"){?>
                                                ...
                                                <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/ArchiveScannedMonthlyRainfallFormDataReportCopy/DisplayFormToArchiveScannedMonthlyRainfallFormReportForUpdate/" .$data->id ;?>" style="cursor:pointer;"> <li class="fa fa-edit"></li> Edit</a>
                                            <?php } else {?>
                                                 <!-- <a class="btn btn-primary btn-xs" href="<?php echo base_url() . "index.php/ArchiveScannedMonthlyRainfallFormDataReportCopy/DisplayFormToArchiveScannedMonthlyRainfallFormReportForUpdate/" .$data->id ;?>" style="cursor:pointer;"> <li class="fa fa-edit"></li> Add comment</a> -->
                                             <?php }?>
                                                </td>
                    <?php if($userrole== 'SeniorDataOfficer' && $data->Approved=="TRUE" ){?>
                        <td><form method="post" action="<?php echo base_url() . "index.php/ArchiveScannedMonthlyRainfallFormDataReportCopy/update_approval/" .$data->id;?>"> <input type="hidden" name="id" value="<?php echo $data->id;?>" ><input type="hidden" name="approve" value="FALSE" ><button class="btn btn-danger btn-xs"  type="submit"  ><li class='fa fa-times'></li> Disapprove</button></form>
                       ...
                       <?php if(isset($observationslipcomments)){ ?>
                              ...
                              <div class="row no-print" style="padding:10px;">
                                ...
                                <div class="col-md-6">
                                <h4 >Add a comment</h4>
                                <form method="post" action="<?php echo base_url(); ?>index.php/ArchiveScannedMonthlyRainfallFormDataReportCopy/submitObservationslipComment/">
