...
if(is_array($displayArchivedMonthlyRainfallFormReportHeaderFields) &&
    ...
    $region=$displayArchivedMonthlyRainfallFormReportHeaderFields['region'];
    $monthAsANumber=0;
    $year=0;
    ...
    $blocknumber=$displayArchivedMonthlyRainfallFormReportHeaderFields['blocknumber'];
     $district =  $displayArchivedMonthlyRainfallFormReportHeaderFields['district'];
    ...
    <span class="dotted-line"><?php echo $region;?></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span><strong>District</strong></span> <span class="dotted-line"><?php echo $district ;?></span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</br>
    <span><strong>Station Name</strong></span> <span class="dotted-line"><?php echo $stationName;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br><br>
    <span><strong>Enter daily totals under date measured</strong></span><br><br>
    ...
    <?php
       ...
       $nine;
        ...
        $max = 0;
         foreach($archivemonthlyrainfallreportdatanextmonth as $data){
...
<table class="report-table">
    ...
    <tr>
        ...
        <td class="main"><?php echo  max($one,$two ,$three,$four,$five,$six,$seven,$eight,$nine,$ten, $eleven ,$twelve,$thirteen,$fourteen,$fifteen, $sixteen ,$seventeen,$eighteen,$nineteen,$twenty,$twentyone,$twentytwo,$twentythree,$twentyfour,$twentyfive,$twentysix,$twentyseven,$twentyeight,$twentynine,$thirty,$thirtyone); ?></td>
        <td class="main"><?php echo $maxraindate ?></td>
...
<br><br>
   ...
   <br><br><br>
    ...
    <a href="<?php echo base_url()."index.php/DisplayArchivedMonthlyRainfallFormReportData/"; ?>" class="btn btn-warning pull-right no-print"><i class="fa fa-times"></i> Close Report</a>
    <div class="clearfix"></div>
    <br><br>
...
is_array($archivedmonthlyrainfallformreportdata) &&
empty($archivedmonthlyrainfallformreportdata) &&
empty($archivemonthlyrainfallreportdatanextmonth)) {
