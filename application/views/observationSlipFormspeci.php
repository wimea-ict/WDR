        ...
        //      public function restrictrange(){
       	...
       	// 			 echo '<span style="color: #ff0000"> Please insert rainfall value less than 38.</span>';
			...
			<div class ="select, col-md-2" >			
                            ...
                            <span>Select cloud type</span><br/><br/>
                            <table  class="table table-bordered table-striped">
                            <tr>
                           <td><a style ="color:black" href ="#low" onclick ="low();">Low</a><br/></td>
					         </tr>
                             <tr>
							<td><a style ="color:black" href ="#medium"  onclick ="med();">Medium</a><br/></td>
			                 </tr>
                             <tr>
                            <td><a  style ="color:black" href ="#high"  onclick ="hig();">High</a></td>
                            </tr>
 						...
 						<tr>
 							...
 							<td>
 								<div class="input-group">
 									...
 									<input type="text" name="pastweatherCode_observationslipform" id="pastweatherCode_observationslipform"  onkeyup="allowIntegerInputOnly(this)" required class="form-control" required placeholder="Enter PAST WEATHER CODE" >
 						...
 						<tr>
 							<td>
 								<div class="input-group">
 									...
 									<input id="inputCelsius1" name="MaxTemp" type="number" onkeyup="allowIntegerInputOnly(this)" class="form-control"  placeholder="Enter max temperature" oninput="temperatureConverter1(this.value)" onchange="temperatureConverter1(this.value)">
 								</div>
 							</td>
 							<td>
 								<div class="input-group">
            	...
            	<table id="example1" class="table table-bordered table-striped">
            		...
            		<tr>
            			...
            			<td>
            				<div class="input-group">
            					<span class="input-group-addon">PAST WEATHER CODE</span>
            					<input type="text" <?php if($userrole=="WeatherForecaster") echo "disabled"; ?> name="pastweatherCode" value="<?php echo $observationslipformidupdate->Past_WeatherCode;?>"  onkeyup="allowIntegerInputOnly(this)" class="form-control" >
						...
						<tbody>
							...
							if('TRUE') {
								foreach($observationslipformdata as $observationslipdata){
                                      $min_temp = intval($observationslipdata->Min_temp);
										$max_temp = intval($observationslipdata->Max_temp);
                                        ...
                                        if($diff_in_hours >=1 ){ // if  weather data submitted late 
                                        	...
                                        	if($min_temp < 9 || $max_temp >38 || $rain > 130 ){
                                        		$class = "bg-dangered ";
                                        		$comment2 ="Unsual value detected";
                                        	}
                                        ...
                                        if($diff_in_hours < 1 ){
                                        	...
                                        	if($min_temp < 9 || $max_temp >38 || $max_temp <9 || $rain > 130 ){
                                        		$class = "bg-info ";
                                        		$comment2 ="Unsual value detected";
                                        	}
									...
									$observationslipid = $observationslipdata->id;
                                        ...
                                        <tr class="<?php echo $class; ?>">
                                        	...
                                        	<td class="change-width">
                                        		...
                                        		<td><?php echo $observationslipdata->TimeMarkstdermo;?></td>
